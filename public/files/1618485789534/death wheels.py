    ...
    if(out_0 == 'N'):
        if(r0.dist < r1.dist or isDamage(1)):
            ...
            if(r0.shb < 500):
                ...
                move0(8)
    if r0.imin == 0 and r0.shf < 700:
        if r0.shr > 300 and r0.shr < 600:
            move0(14)
        elif r0.shf < 700 and r0.shl > 300 and r0.shl < 600:
            move0(2)
    ...
    if(out_1 == 'N'):
        if(r1.dist < r0.dist or isDamage(0)):
            ...
            if(r1.shb < 500):
                ...
                move1(8)
    if r0.imin == 0:
        if r1.shf < 700 and r1.shr > 300 and r1.shr < 600:
            move1(14)
        elif r1.shf < 700 and r1.shl > 300 and r1.shl < 600:
            move1(2)
