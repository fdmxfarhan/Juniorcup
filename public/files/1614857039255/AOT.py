[۱۳:۲۱, ۱۳۹۹/۱۲/۱۴] ⁦+98 930 369 5496⁩: from juniorcup import *
...
…
[۱۳:۴۶, ۱۳۹۹/۱۲/۱۴] ⁦+98 930 369 5496⁩: ریحانه
[۱۳:۴۶, ۱۳۹۹/۱۲/۱۴] ⁦+98 930 369 5496⁩: از کلاس بیا بیرون
[۱۳:۴۶, ۱۳۹۹/۱۲/۱۴] ⁦+98 930 369 5496⁩: دوباره بیا تو
[۱۳:۴۶, ۱۳۹۹/۱۲/۱۴] reyn.som: bashe
[۱۳:۵۲, ۱۳۹۹/۱۲/۱۴] reyn.som: mn vared shodam
[۱۴:۲۸, ۱۳۹۹/۱۲/۱۴] ⁦+98 930 369 5496⁩: from juniorcup import *
...
def move0(dir):
    ...
    if(dir == 6):      motor0(0       , -speed  , 0       , speed    )
…
[۱۴:۴۹, ۱۳۹۹/۱۲/۱۴] reyn.som: https://juniorcup.ir/game/soccer-light?field=A&round=1
[۱۴:۵۱, ۱۳۹۹/۱۲/۱۴] ⁦+98 930 369 5496⁩: from juniorcup import *
...
def out0():
        ...
        while(r0.imin < 8 and r0.min < 700):
            ...
            if(r0.shr < 300): 
                move0(12)
                 ...
                 elif(r0.shr<950):      move0(12)
                 elif(r0.shl<900):      move0(4)
    ...
    if(r0.ldr_f > 500 or (r0.ldr_r>500 and r0.ldr_l>500)):
    ...
    if(r0.ldr_b > 600):
        while(r0.imin < 12 and r0.imin >3   and r0.min < 700):
            r0.sensor()
            if(r0.shb > 300): 
                move0(0)
            else:
    ...
    if(r1.ldr_l > 600):
        while(r1.imin < 8  and r1.min < 700):
            ...
            if(r1.shl < 300): 
                ...
                motor1(0,0,0,0)
    if(r1.ldr_b > 600):
        while(r1.imin < 12 and r1.imin >3   and r1.min < 700):
            r1.sensor()
            if(r1.shb > 300): 
                move1(0)
            else:
...
while True:
    ...
    if(r1.min<800):
        ...
        if(r1.shb>300):    move1(8)
        elif(r1.shr<550):      move1(12)
        elif(r1.shl<500):      move1(4)
