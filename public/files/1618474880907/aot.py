...
def shift0(dir):
    if (r0.dist<50):
        ...
        if(dir == 1):     motor0(speed   , -speed/2, -speed  , speed/2  )#4
        ...
        if(dir == 1):      motor0(speed   , 0       , -speed  , 0        )#2
        if(dir == 2):      motor0(speed   , -speed/2, -speed  , speed/2  )#3
        if(dir == 3):      motor0(speed   , -speed/2, -speed  , speed/2  )#4
        if(dir == 4):      motor0(speed/2 , -speed  , -speed/2, speed    )#5  
        if(dir == 5):      motor0(0       , -speed  , 0       , speed    )#6
        if(dir == 6):      motor0(-speed/2, -speed  , speed/2 , speed    )#7
        if(dir == 7):      motor0(-speed  , -speed  , speed   , speed    )#8   
    
        if(dir == 8):      motor0(-speed/2, -speed  , speed/2 , speed    )#7
     
        if(dir == 9):      motor0(-speed  , -speed  , speed   , speed    )#8
        if(dir == 10):     motor0(-speed   , -speed/2, speed   , speed/2 )#9
        if(dir == 11):     motor0(-speed   , 0       , speed   , 0       )#10
        if(dir == 12):     motor0(-speed   , speed/2 , speed   , -speed/2)#11
        if(dir == 13):     motor0(-speed   , speed   , speed   , -speed  )#12 
        if(dir == 14):     motor0(-speed/2 , speed   , speed/2 , -speed  )#13
...
def shift1(dir):
    if(r1.dist<50):
        ...
        if(dir == 1):      motor1(speed   , 0       , -speed  , 0        )#2
        if(dir == 2):      motor1(speed   , -speed/2, -speed  , speed/2  )#3
        if(dir == 3):      motor1(speed   , -speed/2, -speed  , speed/2  )#4
        if(dir == 4):      motor1(speed/2 , -speed  , -speed/2, speed    )#5  
        if(dir == 5):      motor1(0       , -speed  , 0       , speed    )#6
        if(dir == 6):      motor1(-speed/2, -speed  , speed/2 , speed    )#7
        if(dir == 7):      motor1(-speed  , -speed  , speed   , speed    )#8   
    
        if(dir == 8):      motor1(-speed/2, -speed  , speed/2 , speed    )#7
     
        if(dir == 9):      motor1(-speed  , -speed  , speed   , speed    )#8
        if(dir == 10):     motor1(-speed   , -speed/2, speed   , speed/2 )#9
        if(dir == 11):     motor1(-speed   , 0       , speed   , 0       )#10
        if(dir == 12):     motor1(-speed   , speed/2 , speed   , -speed/2)#11
        if(dir == 13):     motor1(-speed   , speed   , speed   , -speed  )#12 
        if(dir == 14):     motor1(-speed/2 , speed   , speed/2 , -speed  )#13
        if(dir == 15):     motor1(-speed/2 , speed   , speed/2 , -speed  )#13
...
def out0():
    ...
    if(r0.ldr_b > 600 or (r0.ldr_r > 600 and r0.ldr_l > 600 )):
        while(r0.imin > 2  and r0.imin < 12 and r0.min < 700):
            r0.sensor()
            compass()
            r1.sensor()
            darvazeban()
...
def out1():
    ...
    if(r1.ldr_b > 600 or (r1.ldr_r > 600 and r1.ldr_l > 600 )):
        while(r1.imin > 2  and r1.imin < 12 and r1.min < 700):
            r1.sensor()
            compass()
            r0.sensor()
            if(r1.shb < 300): 
...
while True:
    ...
    if( r0.imin == 0 and r0.min==0 and r0.ldr_b==0 and r0.ldr_f==0 and r0.ldr_l==0 and r0.ldr_r==0):
        if(r1.ldr_r<600 and r1.ldr_l<600):
            if (r1.min<800):         shift1(r1.imin)
               ...
               if(r1.ldr_r>700):       move1(12)    
               elif(r1.ldr_l>700):     move1(4)
    else:

        if(r1.ldr_r<700 and r1.ldr_l<700 and r1.ldr_f<700 and r1.ldr_b<700):
            if(r1.min<800 and r1.shb>400):
                move1(8)
            elif(r1.min<800 and r1.shb<350):
                move1(0)      
            elif(r1.min<800 and r1.imin==0):
                r1.motor(cmp1,cmp1,cmp1,cmp1)
            elif(r1.min<800 and r1.imin<8 and r1.shr>500 ):
