...
def compass():
    ...
    if (cmp1>-40 and cmp1<40):   cmp1 = -cmp1*2
    else:                        cmp1=  -cmp1
...
def out0():
    if r0.shr<400:
        if r0.ldr_r>700 and r0.imin<8:
            move0(12)
    if r0.shl<400:
        if r0.ldr_l>700 and r0.imin>8:
            move0(4)
    if r0.shf<400:
        if r0.ldr_f>700 and (r0.imin<4 or r0.imin>12):
            move0(8)
    if r0.shb<400:
        if r0.ldr_b>700 and (r0.imin>4 and r0.imin<12):
            move0(0)
...
##            else:
##                motor1(0,0,0,0)
##    elif(r1.ldr_b > 600 or(r1.ldr_r>600 and r1.ldr_l>600)):
...
##            else:
##                motor1(0,0,0,0)
##    elif(r1.ldr_f > 600 or(r1.ldr_r>600 and r1.ldr_l>600)):
##        while(r1.imin < 4 and r1.imin > 12 and r1.min < 700):
##            r1.sensor()
##            compass()
##            
...
while True:
    ...
    out0()
    print(r0.shr,r0.shl,r0.shf,r0.shb,r0.dist)
