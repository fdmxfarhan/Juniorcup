...
def shift0(dir):
    ...
    if(dir == 1):      motor0(speed   , speed   , -speed  , -speed   )#0
    if(dir == 2):      motor0(speed/2 , -speed  , -speed/2, speed    )#5
    if(dir == 3):      motor0(0       , -speed  , 0       , speed    )#6
    if(dir == 4):      motor0(0       , -speed  , 0       , speed    )#7  
    if(dir == 5):      motor0(-speed/2, -speed  , speed/2 , speed    )#8  
    if(dir == 6):      motor0(-speed   , -speed/2, speed   , speed/2 )#9
    if(dir == 7):      motor0(-speed   , -speed/2, speed   , speed/2 )#10 

    if(dir == 8):      motor0(-speed   , 0       , speed   , 0       )#10
    
    if(dir == 9):      motor0(0       , -speed  , 0       , speed    )#6
    if(dir == 10):     motor0(0       , -speed  , 0       , speed    )#7  
    if(dir == 11):     motor0(-speed/2, -speed  , speed/2 , speed    )#8  
...
def shift1(dir):
    ...
    if(dir == 4):      motor1(0       , -speed  , 0       , speed    )#7  
    if(dir == 5):      motor1(-speed/2, -speed  , speed/2 , speed    )#8  
    if(dir == 6):      motor1(-speed   , -speed/2, speed   , speed/2 )#9
    if(dir == 7):      motor1(-speed   , -speed/2, speed   , speed/2 )#10 

    if(dir == 8):      motor1(-speed   , 0       , speed   , 0       )#10
    
    if(dir == 9):      motor1(0       , -speed  , 0       , speed    )#6
    if(dir == 10):     motor1(0       , -speed  , 0       , speed    )#7  
    if(dir == 11):     motor1(-speed/2, -speed  , speed/2 , speed    )#8  
    ...
    if(dir == 15):     motor0(0        , speed   , 0       , -speed  )#14
...
while True:
    ...
    if r1.min<800:      shift1(r1.imin)
        ...
        if (r1.shb>350):       move1(8)
        elif (r1.shr<750):     move1(12)
        elif (r1.shl<750):     move1(4)
