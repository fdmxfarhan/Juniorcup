...
def shift1(dir):
    ...
    if(dir == 3):      motor1(speed   , -speed/2, -speed  , speed/2  )#3
    ...
    if(dir == 13):     motor1(-speed/2 , speed   , speed/2 , -speed  )#13
...
while True:
    ...
    # if (r0.min<800):      
    #     while((r0.ldr_r>600 or r0.ldr_l>600) and (r0.imin>4 and r0.imin<12)):
    #         r0.sensor()
    #         move0(8)
    #     shift0(r0.imin)
    # else:             
