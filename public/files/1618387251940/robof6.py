...
def darvazeban():
    if(r1.ldr_r<700 and r1.ldr_l<700 and r1.ldr_f<700 and r1.ldr_b<700):
        if(r1.shb>400):        move1(8)
        elif(r1.shb<300):      move1(0)
        elif(r1.min<800 and r1.imin==0):                   r1.motor(cmp1,cmp1,cmp1,cmp1)
        elif(r1.min<800 and r1.imin < 8 and r1.shr>500):   move1(4)
        elif(r1.min<800 and r1.imin > 8 and r1.shl>500):   move1(12) 
...
while True:
        ...
        if(r0.ldr_r < 600 and r0.ldr_l < 600 and r0.ldr_f < 600 and r0.ldr_b < 600):
            if r0.min<800:       shift0(r0.imin)      
            else:
                if(r0.shb>300):        move0(8)
                elif(r0.shr<800):      move0(12)
