...
def shift0(dir):
    if (r0.dist<50):
        ...
        if(dir == 0):   
            #if (r0.shr>300 and r0.shr<600): 
             #   motor0(speed   , -speed/2, -speed  , speed/2  )#3   
            #elif (r0.shl>300 and r0.shl<600):
             #   motor0(-speed/2 , speed   , speed/2 , -speed  )#13
            #else:
            motor0(speed   , speed   , -speed  , -speed   )#0
