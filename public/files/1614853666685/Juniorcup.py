...
def move1(direction):
    ...
    if(direction == 2):      r1.motor(speed+cmp1   , 0       , -speed+cmp1  , 0        )
    ...
    if(direction == 6):      r1.motor(0       , -speed+cmp1  , 0       , speed+cmp1    )
    ...
    if(direction == 10):     r1.motor(-speed+cmp1   , 0       , speed+cmp1   , 0       )
    ...
    if(direction == 14):     r1.motor(0        , speed+cmp1   , 0       , -speed+cmp1  )
