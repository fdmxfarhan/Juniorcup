...
def shift0(dir):
    ...
    if (dir == 1):
        if ((r0.shr >= 290) and (r0.shf >= 280)): motor0(speed, -speed/2, -speed, speed/2)#3
        elif (r0.shr < 290): motor0(speed, speed, -speed, -speed)
        elif (r0.shf < 280): motor0(speed, -speed, -speed, speed)
        else: motor0(0, 0, 0, 0)
    if (dir == 2): motor0(speed, -speed, -speed, speed)#4
    if (((dir == 3) or (dir == 4)) or (dir == 9)):
        if ((r0.shr >= 290) and (r0.shb >= 370)): motor0(0, -speed, 0, speed)#6
        elif (r0.shr < 290): motor0(-speed, -speed, speed, speed)
        elif (r0.shb < 370): motor0(speed, -speed, -speed, speed)
        else: motor0(0, 0, 0, 0)
    if ((((dir == 5) or (dir == 6)) or (dir == 10)) or (dir == 11)): motor0(-speed, -speed, speed, speed)#8
    if (((dir == 7) or (dir == 12)) or (dir == 13)):
        if ((r0.shl >= 380) and (r0.shb >= 370)): motor0(-speed , 0 , speed , 0)#10
        elif (r0.shl < 380): motor0(-speed, -speed, speed, speed)
        elif (r0.shb < 370): motor0(-speed, speed, speed, -speed)
        else: motor0(0, 0, 0, 0)
    if (dir == 8):
        if ((r0.shr >= 290) and (r0.shb >= 370)): motor0(speed/2 , -speed , -speed/2, speed)#5
        elif (r0.shr < 290): motor0(-speed, -speed, speed, speed)
        elif (r0.shb < 370): motor0(speed, -speed, -speed, speed)
        else: motor0(0, 0, 0, 0)
    if (dir == 14): motor0(-speed , speed , speed , -speed )#12
    if (dir == 15):
        if ((r0.shl >= 380) and (r0.shf >= 280)): motor0(-speed/2 , speed , speed/2 , -speed )#13
        elif (r0.shl < 380): motor0(speed, speed, -speed, -speed)
        elif (r0.shf < 280): motor0(-speed, speed, speed, -speed)
        else: motor0(0, 0, 0, 0)
